...
-- ══════════════════════════════════════════
-- CONFIGURAÇÕES DO TEMA - FÊNIX PvP
-- ══════════════════════════════════════════
local Theme = {
    -- Laranja Fogo como cor principal
    Primary = Color3.fromRGB(255, 100, 30),
    PrimaryDark = Color3.fromRGB(200, 60, 10),
    PrimaryLight = Color3.fromRGB(255, 140, 60),
    PrimaryGlow = Color3.fromRGB(255, 120, 40),
    -- Roxo escuro como secundário
    Secondary = Color3.fromRGB(160, 80, 255),
    Background = Color3.fromRGB(10, 6, 15),
    BackgroundAlt = Color3.fromRGB(15, 10, 22),
    BackgroundCard = Color3.fromRGB(22, 14, 30),
    Surface = Color3.fromRGB(30, 20, 40),
    SurfaceHover = Color3.fromRGB(42, 28, 55),
    SurfaceBorder = Color3.fromRGB(60, 30, 20),
    TextPrimary = Color3.fromRGB(255, 255, 255),
    TextSecondary = Color3.fromRGB(210, 180, 170),
    TextMuted = Color3.fromRGB(130, 100, 90),
...
local Config = {
    ...
    HubName = "🔥 Fênix PvP",
    Version = "🔥 Alisson Gostoso do caralho 🔥",
    AnimSpeed = 0.4,
}
...
local S = {
    ...
    TargetPlayer = nil,
    AntiAFK = false,
    ChatSpam = false, ChatMsg = "Fenix PvP 🔥",
    ClickTP = false,
    ClickDelete = false,
    InfYield = false,
    AutoFarm = false,
    ...
    SavedPositions = {},
    -- AvsX
    AvsX_SilentAim = false, AvsX_ShootDist = 150,
    AvsX_KnifeAura = false, AvsX_KnifeDist = 15,
    AvsX_AutoDodge = false,
}
...
-- ══════════════════════════════════════════
pcall(function()
    if CoreGui:FindFirstChild("FenixPvP") then CoreGui.FenixPvP:Destroy() end
end)
if Player.PlayerGui:FindFirstChild("FenixPvP") then Player.PlayerGui.FenixPvP:Destroy() end
...
local function Notify(title, msg, dur, ntype)
    ...
    local ico = icons[ntype or "info"] or "🔥"
...
-- ══════════════════════════════════════════
-- TELA DE INTRO - TEMA Fenix
-- ══════════════════════════════════════════
local function PlayIntro()
    local introFrame = Instance.new("Frame")
    introFrame.Name = "Intro"
    introFrame.BackgroundColor3 = Color3.fromRGB(8, 4, 10)
    ...
    bgGrad.BackgroundColor3 = Color3.fromRGB(15, 8, 15)
    ...
    bgGradEffect.Color = ColorSequence.new({
        ...
        ColorSequenceKeypoint.new(0.4, Color3.fromRGB(20, 10, 18)),
        ColorSequenceKeypoint.new(0.7, Color3.fromRGB(30, 15, 25)),
    ...
    for i = 1, 12 do
        task.spawn(function()
            while task.wait(math.random(15, 40) / 100) do
                ...
                line.BackgroundColor3 = Color3.fromRGB(255, 100, 30)
    ...
    -- ══ LOGO Fenix REMOVIDO A PEDIDO ══
    task.wait(1.4)

    -- ══ TEXTO DO TÍTULO ══
    local title = Instance.new("TextLabel")
    title.Text = "🔥 Fenix PvP"
    title.Font = Enum.Font.GothamBold
    title.TextSize = 38
    title.TextColor3 = Color3.fromRGB(255, 100, 30)
    ...
    titleShadow.Text = "🔥 Fenix PvP"
    titleShadow.Font = Enum.Font.GothamBold
    titleShadow.TextSize = 38
    titleShadow.TextColor3 = Color3.fromRGB(180, 50, 20)
    ...
    titleLine.BackgroundColor3 = Color3.fromRGB(255, 100, 30)
    ...
    tlGrad.Color = ColorSequence.new(Color3.fromRGB(200, 60, 10), Color3.fromRGB(255, 140, 60))
    tlGrad.Rotation = 0
    ...
    subtitle.TextColor3 = Color3.fromRGB(200, 120, 80)
    ...
    slogan.Text = '"Das cinzas renasce o poder" 🦅'
    slogan.Font = Enum.Font.GothamBold
    slogan.TextSize = 12
    slogan.TextColor3 = Color3.fromRGB(255, 100, 30)
    ...
    progressBG.BackgroundColor3 = Color3.fromRGB(35, 20, 30)
    ...
    MakeStroke(progressBG, Color3.fromRGB(80, 40, 60), 1, 0.3)

    -- Posição Y via Position
    progressBG.Position = UDim2.new(0.5, -185, 0.745, 0)

    local progressFill = Instance.new("Frame")
    progressFill.BackgroundColor3 = Color3.fromRGB(255, 100, 30)
    ...
    percentTxt.TextColor3 = Color3.fromRGB(255, 100, 30)
    ...
    statusTxt.Text = "Preparando o renascimento..."
    statusTxt.Font = Enum.Font.Gotham
    statusTxt.TextSize = 12
    statusTxt.TextColor3 = Color3.fromRGB(180, 100, 70)
    ...
    -- Velocímetro decorativo (detalhe fenix)
    local speedoFrame = Instance.new("Frame")
    speedoFrame.BackgroundColor3 = Color3.fromRGB(20, 10, 18)
    ...
    MakeStroke(speedoFrame, Color3.fromRGB(255, 100, 30), 1, 0.5)

    local speedoTxt = Instance.new("TextLabel")
    speedoTxt.Text = "🏁 0 PWR"
    speedoTxt.Font = Enum.Font.GothamBold
    speedoTxt.TextSize = 12
    speedoTxt.TextColor3 = Color3.fromRGB(255, 100, 30)
    ...
    bottomText.Text = "Right Ctrl para toggle  •  Criado por Mia Khalifa  🔥"
    bottomText.Font = Enum.Font.Gotham
    bottomText.TextSize = 11
    bottomText.TextColor3 = Color3.fromRGB(140, 80, 60)
    ...
    -- ══ LOADING COM TEMÁTICA fenix ══
    local steps = {
        {p = 0.08,  s = "🔑 Acendendo as chamas...",               t = 0.25, km = 50},
        {p = 0.16,  s = "⚙️  Invocando a Fenix...",         t = 0.30, km = 150},
        {p = 0.25,  s = "🔥  Renascendo das cinzas...",           t = 0.35, km = 280},
        ...
        {p = 0.90,  s = "⚡  Poder maximo liberado...",           t = 0.22, km = 850},
        {p = 0.96,  s = "🏁  A Fenix renasceu...",   t = 0.20, km = 950},
        {p = 1.00,  s = "✅  FENIX PvP ATIVO!",          t = 0.15, km = 1000},
    }
    ...
    passInput.BackgroundColor3 = Color3.fromRGB(35, 20, 30)
    ...
    MakeStroke(passInput, Color3.fromRGB(80, 40, 60), 1, 0)
    ...
    passBtn.BackgroundColor3 = Color3.fromRGB(255, 100, 30)
    ...
    statusTxt.TextColor3 = Color3.fromRGB(255, 100, 30)
    ...
    -- Tween(logoContainer, {Position = UDim2.new(0.5, 0, 0.25, 0)}, 0.5, Enum.EasingStyle.Quint) -- FIXED

    repeat task.wait(0.1) until passPassed

    -- ══ SAÍDA CINEMATOGRÁFICA ══
    -- Escudo "lança" para cima com velocidade
    -- Tween(logoContainer, { -- FIXED
    ...
    -- Flash amarelo fenix antes de abrir
...
local function BuildUI()
    ...
    -- Faixa amarela Fenix no topo
    local topAccent = Instance.new("Frame")
    topAccent.BackgroundColor3 = Color3.fromRGB(255, 100, 30)
    ...
    tacGrad.Color = ColorSequence.new(Color3.fromRGB(200, 60, 10), Color3.fromRGB(255, 140, 60))
    tacGrad.Rotation = 0
    ...
    topTitle.TextColor3 = Color3.fromRGB(255, 100, 30)
    ...
    sidebarSep.BackgroundColor3 = Color3.fromRGB(80, 40, 60)
    ...
    MakeStroke(avatarImg, Color3.fromRGB(255, 100, 30), 2, 0.2)
    ...
    nameLabel.TextColor3 = Color3.fromRGB(255, 100, 30)
    ...
    sepLine.BackgroundColor3 = Color3.fromRGB(100, 50, 70)
    ...
    local tabs = {
        ...
        {name = "AvsX",     icon = "🔫", order = 2},
        {name = "Player",   icon = "👤", order = 3},
        {name = "Combat",   icon = "⚔️", order = 4},
        {name = "Visuals",  icon = "👁️", order = 5},
        {name = "Teleport", icon = "🌍", order = 6},
        {name = "Troll",    icon = "😈", order = 7},
        {name = "Misc",     icon = "🔧", order = 8},
        {name = "Server",   icon = "🖥️", order = 9},
        {name = "Settings", icon = "⚙️", order = 10},
    }
    ...
    for _, ti in ipairs(tabs) do
        ...
        indicator.BackgroundColor3 = Color3.fromRGB(255, 100, 30)
        ...
        indGrad.Color = ColorSequence.new(Color3.fromRGB(255, 100, 30), Color3.fromRGB(200, 60, 10))
        indGrad.Rotation = 90
        ...
        page.ScrollBarImageColor3 = Color3.fromRGB(255, 100, 30)
        ...
        btn.MouseEnter:Connect(function()
            if S.CurrentTab ~= ti.name then
                Tween(btn, {BackgroundTransparency = 0.6, TextColor3 = Color3.fromRGB(230, 90, 40)}, 0.2)
            end
        end)
        btn.MouseLeave:Connect(function()
            if S.CurrentTab ~= ti.name then
        ...
        btn.MouseButton1Click:Connect(function()
            ...
            Tween(btn, {BackgroundTransparency = 0.25, TextColor3 = Color3.fromRGB(255, 100, 30)}, 0.2)
            btn.Font = Enum.Font.GothamBold
    ...
    if tabBtns["Home"] then
        ...
        Tween(tabBtns["Home"], {BackgroundTransparency = 0.25, TextColor3 = Color3.fromRGB(255, 100, 30)}, 0.1)
...
local function Section(parent, title, order)
    ...
    sec.Parent = parent
    MakeCorner(sec, 10)
    MakeStroke(sec, Color3.fromRGB(60, 30, 50), 1, 0.3)
    ...
    if title then
        ...
        tl.Font = Enum.Font.GothamBold
        tl.TextSize = 14
        tl.TextColor3 = Color3.fromRGB(255, 100, 30)
        tl.TextXAlignment = Enum.TextXAlignment.Left
        tl.BackgroundTransparency = 1
        ...
        sp.BackgroundColor3 = Color3.fromRGB(80, 40, 60)
...
local function Toggle(parent, text, default, callback, order)
    ...
    bg.BackgroundColor3 = default and Color3.fromRGB(255, 100, 30) or Theme.BackgroundCard
    ...
    btn.MouseButton1Click:Connect(function()
        enabled = not enabled
        if enabled then
            Tween(bg, {BackgroundColor3 = Color3.fromRGB(255, 100, 30)}, 0.2)
    ...
    return cont, function() return enabled end, function(val)
        enabled = val
        if enabled then
            bg.BackgroundColor3 = Color3.fromRGB(255, 100, 30)
...
local function Slider(parent, text, min, max, default, callback, order)
    ...
    valLbl.TextSize = 12
    valLbl.TextColor3 = Color3.fromRGB(255, 100, 30)
    ...
    slFill.BackgroundColor3 = Color3.fromRGB(255, 100, 30)
    slFill.Size = UDim2.new(initPct, 0, 1, 0)
    slFill.ZIndex = 16
    slFill.Parent = slBg
    MakeCorner(slFill, 3)
    local slGrad = Instance.new("UIGradient")
    slGrad.Color = ColorSequence.new(Color3.fromRGB(200, 60, 10), Color3.fromRGB(255, 140, 60))
    slGrad.Rotation = 0
    slGrad.Parent = slFill

    local knob = Instance.new("Frame")
    knob.BackgroundColor3 = Color3.fromRGB(255, 100, 30)
...
local function Button(parent, text, callback, order, color)
    ...
    if not color then
        ...
        bGrad.Color = ColorSequence.new(Color3.fromRGB(255, 220, 40), Color3.fromRGB(200, 60, 10))
        bGrad.Rotation = 90
        bGrad.Parent = btn
    end
...
local function TextInput(parent, placeholder, callback, order)
    ...
    input.Focused:Connect(function()
        MakeStroke(cont, Color3.fromRGB(255, 100, 30), 1.5, 0.1).Name = "FStroke"
    end)
...
local function Dropdown(parent, text, options, callback, order)
    ...
    for i, opt in ipairs(options) do
        ...
        optBtn.MouseEnter:Connect(function()
            Tween(optBtn, {BackgroundTransparency = 0.2, TextColor3 = Color3.fromRGB(255, 100, 30)}, 0.15)
        end)
        ...
        for _, plr in pairs(Players:GetPlayers()) do
            if plr ~= Player then
                ...
                b.MouseEnter:Connect(function()
                    Tween(b, {BackgroundTransparency = 0.2, TextColor3 = Color3.fromRGB(255, 100, 30)}, 0.15)
                end)
...
local function SetupHome()
    ...
    -- Banner temático Fenix
    local banner = Instance.new("Frame")
    banner.BackgroundColor3 = Color3.fromRGB(25, 12, 22)
    banner.Size = UDim2.new(1, 0, 0, 110)
    banner.ZIndex = 13
    banner.LayoutOrder = 1
    banner.Parent = p
    MakeCorner(banner, 12)
    MakeStroke(banner, Color3.fromRGB(255, 100, 30), 1.5, 0.2)

    -- Gradiente amarelo/preto fenix
    local banGrad = Instance.new("UIGradient")
    banGrad.Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0, Color3.fromRGB(40, 20, 35)),
    ...
    banStripe.BackgroundColor3 = Color3.fromRGB(255, 100, 30)
    ...
    bsGrad.Color = ColorSequence.new(Color3.fromRGB(255, 140, 60), Color3.fromRGB(200, 60, 10))
    bsGrad.Rotation = 90
    bsGrad.Parent = banStripe

    local bTitle = Instance.new("TextLabel")
    bTitle.Text = "🔥 Fenix PvP"
    bTitle.Font = Enum.Font.GothamBold
    bTitle.TextSize = 26
    bTitle.TextColor3 = Color3.fromRGB(255, 100, 30)
    ...
    bSlogan.Text = '"Das cinzas renasce o poder" 🦅'
    bSlogan.Font = Enum.Font.GothamBold
    bSlogan.TextSize = 11
    bSlogan.TextColor3 = Color3.fromRGB(200, 120, 80)
    ...
    local function Stat(parent, icon, label, val, ord)
        ...
        sv.TextSize = 12
        sv.TextColor3 = Color3.fromRGB(255, 100, 30)
    ...
    Label(info, "🔥 Fenix PvP — Premium Ativo ✓", 8)
end

local function SetupAvsX()
    local p = tabPages["AvsX"]
    if not p then return end

    local banner = Section(p, "🏆 Duelos: Assassinos VS Xerifes", 1)
    Label(banner, "Módulo focado exclusivamente para ganhar nos Duelos!", 2)

    local xerife = Section(p, "🔫 Modos de Xerife", 2)
    Toggle(xerife, "🎯 Silent Aim (Atira no Assassino)", false, function(v)
        S.AvsX_SilentAim = v
        Notify("Silent Aim", v and "Ativado para Arma!" or "Desativado!", 2, v and "success" or "info")
    end, 5)
    Slider(xerife, "Distância do Tiro", 10, 500, 150, function(v) S.AvsX_ShootDist = v end, 6)

    local assassino = Section(p, "🔪 Modos de Assassino", 3)
    Toggle(assassino, "💀 Knife Aura (Mata automático)", false, function(v)
        S.AvsX_KnifeAura = v
        Notify("Knife Aura", v and "Ativado para Faca!" or "Desativado!", 2, v and "success" or "info")
    end, 5)
    Slider(assassino, "Alcance da Faca", 5, 50, 15, function(v) S.AvsX_KnifeDist = v end, 6)

    local util = Section(p, "⚡ Utilitários Especiais", 4)
    Toggle(util, "🏃 Auto Dodge (Desviar de tiros)", false, function(v)
        S.AvsX_AutoDodge = v
        Notify("Auto Dodge", v and "Esquivando!" or "Desativado!", 2, v and "warning" or "info")
    end, 5)
    Button(util, "🚀 TP nas Costas do Inimigo", function()
        local r = GetRoot()
        if r then
            for _, plr in pairs(Players:GetPlayers()) do
                if plr ~= Player and plr.Character then
                    ...
                    if tr then
                        ...
                        Notify("TP Costas", "Nas costas de " .. plr.DisplayName .. "!", 2, "success")
                        break
                    end
                end
            end
    ...
    Button(util, "👁️ ESP do Inimigo", function()
        S.ESP = true
        Notify("ESP", "Visão raio-x ativada!", 2, "success")
    end, 7)
end
...
local function SetupPlayer()
    ...
    Button(acts, "🔦 Lanterna no Head", function()
        pcall(function()
            local head = GetHead()
            if head and not head:FindFirstChild("FenixLight") then
                ...
                local l = head:FindFirstChild("FenixLight")
        ...
        if not v then
            for _, plr in pairs(Players:GetPlayers()) do
                if plr.Character then
                    local h = plr.Character:FindFirstChild("FenixHL")
...
local function SetupTroll()
        ...
        if S.TargetPlayer then
            pcall(function()
                ...
                if chatEvents then
                    ...
                    if say then say:FireServer("🔥 " .. S.TargetPlayer.DisplayName .. " está sendo trollado pelo Fenix PvP!", "All") end
                end
            end)
    ...
    Button(allTroll, "📢 Spam Chat", function()
        pcall(function()
            ...
            if chatEvents then
                local say = chatEvents:FindFirstChild("SayMessageRequest")
                if say then say:FireServer("🔥 Fenix PvP — O mais veloz do Roblox! 🦅", "All") end
            end
        end)
    end, 5)
...
local function SetupMisc()
    ...
    Button(charMisc, "🔥 fenix Mode (Amarelo Neon)", function()
        pcall(function()
            for _, part in pairs(GetChar():GetDescendants()) do
                if part:IsA("BasePart") then
                    part.Material = Enum.Material.Neon
        ...
        Notify("fenix!", "Você virou uma Fenix! 🔥", 2, "success")
    end, 8)
...
local function SetupSettings()
    ...
    Dropdown(uiSec, "🎨 Cor do Tema", {"Amarelo fenix (Padrão)", "Roxo", "Azul", "Verde", "Vermelho", "Rosa", "Cyan"}, function(opt)
        local colors = {
            ["Amarelo fenix (Padrão)"] = Color3.fromRGB(255, 100, 30),
    ...
    Label(credits, "🔥 " .. Config.HubName, 5)
    Label(credits, "🔨 Script Hub Premium — Tema Fenix", 6)
    Label(credits, '🦅 "Das cinzas renasce o poder"', 7)
    Label(credits, "📅 2025 — Todos os direitos reservados", 8)
    Label(credits, "❤️ Desenvolvido por Mia Khalifa", 9)
...
local function StartLoops()
    ...
    RunService.Heartbeat:Connect(function()
        if S.ESP or S.Chams then
            for _, plr in pairs(Players:GetPlayers()) do
                if plr ~= Player and plr.Character then
                    if S.Chams then
                        if not plr.Character:FindFirstChild("FenixHL") then
                            local hl = Instance.new("Highlight")
                            hl.Name = "FenixHL"
                            hl.FillColor = Color3.fromRGB(255, 100, 30)
                            hl.FillTransparency = 0.65
                            hl.OutlineColor = Color3.fromRGB(255, 100, 30)
                    ...
                    if S.ESP then
                        ...
                        if head then
                            if not head:FindFirstChild("FenixESP") then
                                ...
                                nm.TextColor3 = Color3.fromRGB(255, 100, 30)
                            ...
                            local bb = head:FindFirstChild("FenixESP")
                            if bb then
                                local r = GetRoot()
                                if r then
                        ...
                        for _, d in pairs(plr.Character:GetDescendants()) do
                            if d.Name == "FenixESP" then d:Destroy() end
                        end
                    end
                end
            end
                ...
                if plr ~= Player and plr.Character then
                    ...
                    if r then
                        if not isTeammate then
                            ...
                            r.Transparency = 0.7
                            r.BrickColor = BrickColor.new("Bright orange")
                ...
                pcall(function()
                    ...
                    if tool and r then
                        for _, plr in pairs(Players:GetPlayers()) do
                            if plr ~= Player and plr.Character then
                                local tr = plr.Character:FindFirstChild("HumanoidRootPart")
                                if tr and (r.Position - tr.Position).Magnitude <= S.AvsX_KnifeDist then
                                    tool:Activate()
                                end
                            end
                        end
    ...
    RunService.RenderStepped:Connect(function()
        if S.AvsX_AutoDodge then
            pcall(function()
                local r = GetRoot()
                if r then
                    dodgeTick = dodgeTick + 1
                    local offset = math.sin(dodgeTick / 5) * 20
                    r.Velocity = Vector3.new(offset, r.Velocity.Y, offset)
                end
            end)
        end
        if S.AimBot or S.AvsX_SilentAim then
            pcall(function()
                    ...
                    if plr ~= Player and plr.Character then
                        ...
                        if head then
                            ...
                            if onScreen then
                                ...
                                local maxDist = S.AimBot and 300 or S.AvsX_ShootDist
                                if dist < closestDist and dist < maxDist then closestDist = dist; closest = head end
                            end
                        end
                    end
                end
                if closest then
                    ...
                    if S.AvsX_SilentAim then
                        -- Força o personagem a olhar para o alvo e atira
                        local char = GetChar()
                        local tool = char:FindFirstChildOfClass("Tool")
                        if tool then
                            r.CFrame = CFrame.new(r.Position, Vector3.new(closest.Position.X, r.Position.Y, closest.Position.Z))
                            if math.random() > 0.5 then tool:Activate() end
                        end
                    end
                end
            end)
...
local function CreateWatermark()
    ...
    wm.BackgroundColor3 = Color3.fromRGB(15, 8, 15)
    ...
    wm.Parent = gui
    MakeCorner(wm, 6)
    MakeStroke(wm, Color3.fromRGB(255, 100, 30), 1.5, 0.2)

    -- Detalhe lateral fenix
    local accent = Instance.new("Frame")
    accent.BackgroundColor3 = Color3.fromRGB(255, 100, 30)
    ...
    acGrad.Color = ColorSequence.new(Color3.fromRGB(255, 140, 60), Color3.fromRGB(200, 60, 10))
    acGrad.Rotation = 90
    acGrad.Parent = accent

    local wmTxt = Instance.new("TextLabel")
    wmTxt.Text = "🔥 Fenix PvP │ FPS: -- │ Ping: --ms"
    wmTxt.Font = Enum.Font.GothamBold
    wmTxt.TextSize = 11
    wmTxt.TextColor3 = Color3.fromRGB(255, 100, 30)
    ...
    task.spawn(function()
        while task.wait(0.5) do
            pcall(function()
                local fps = math.floor(1 / RunService.RenderStepped:Wait())
                local ping = math.floor(Player:GetNetworkPing() * 1000)
                wmTxt.Text = string.format("🔥 Fenix PvP │ FPS: %d │ Ping: %dms", fps, ping)
            end)
        end
    end)
end
...
-- ══════════════════════════════════════════
    ...
    StartLoops()
    task.wait(0.5)
    Notify("🔥 Fenix PvP", "Carregado! Pressione RightCtrl para toggle.", 4, "success")
    Notify("🦅 Bem-vindo", "Olá, " .. Player.DisplayName .. "! Das cinzas renasce o poder!", 3, "info")
end)

print("══════════════════════════════════════")
print("  🔥 Fenix PvP — Carregado!")
print("  👤 " .. Player.DisplayName .. " (@" .. Player.Name .. ")")
print("  🎮 Place: " .. game.PlaceId)
print("  🔑 Toggle: Right Control")
print("  🦅 Das cinzas renasce o poder!")
print("══════════════════════════════════════") 
